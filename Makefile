# This Makefile is for the MooseX::POE extension to perl.
#
...
#     AUTHOR => q[Chris Prather  C<< <perigrin@cpan.org> >>]
#     DIR => []
#     DISTNAME => q[MooseX-POE]
#     NAME => q[MooseX::POE]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0.42], POE=>q[0.9999], Moose=>q[0.26] }
#     VERSION => q[0.01]
#     dist => { PREOP=>q[$(PERL) -I. "-MModule::Install::Admin" -e "dist_preop(q($(DISTVNAME)))"] }
#     test => { TESTS=>q[t/00.load.t t/01_basic.t t/02_forkbomb.t t/kwalitee.t t/perlcritic.t t/pod-coverage.t t/pod.t] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/MooseX/POE.pm \
	lib/MooseX/POE/Meta/Class.pm \
	lib/MooseX/POE/Meta/Instance.pm \
	lib/MooseX/POE/Object.pm
...
TO_INST_PM = lib/MooseX/POE.pm \
	lib/MooseX/POE/Meta/Class.pm \
	lib/MooseX/POE/Meta/Instance.pm \
	lib/MooseX/POE/Object.pm

PM_TO_BLIB = lib/MooseX/POE/Meta/Class.pm \
	blib/lib/MooseX/POE/Meta/Class.pm \
	lib/MooseX/POE/Meta/Instance.pm \
	blib/lib/MooseX/POE/Meta/Instance.pm \
	lib/MooseX/POE/Object.pm \
	blib/lib/MooseX/POE/Object.pm \
	lib/MooseX/POE.pm \
	blib/lib/MooseX/POE.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/MooseX/POE/Meta/Class.pm $(INST_MAN3DIR)/MooseX::POE::Meta::Class.$(MAN3EXT) \
	  lib/MooseX/POE/Meta/Instance.pm $(INST_MAN3DIR)/MooseX::POE::Meta::Instance.$(MAN3EXT) \
	  lib/MooseX/POE/Object.pm $(INST_MAN3DIR)/MooseX::POE::Object.$(MAN3EXT) \
	  lib/MooseX/POE.pm $(INST_MAN3DIR)/MooseX::POE.$(MAN3EXT) 
...
TEST_FILE = test.pl
TEST_FILES = t/00.load.t t/01_basic.t t/02_forkbomb.t t/kwalitee.t t/perlcritic.t t/pod-coverage.t t/pod.t
TESTDB_SW = -d
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Chris Prather  C&lt;&lt; &lt;perigrin@cpan.org&gt; &gt;&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Moose" VERSION="0,26,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="POE" VERSION="0,9999,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/MooseX/POE/Meta/Class.pm blib/lib/MooseX/POE/Meta/Class.pm \
	  lib/MooseX/POE/Meta/Instance.pm blib/lib/MooseX/POE/Meta/Instance.pm \
	  lib/MooseX/POE/Object.pm blib/lib/MooseX/POE/Object.pm \
	  lib/MooseX/POE.pm blib/lib/MooseX/POE.pm 
